  ...
  },
{
  ...
  },
  {
    id: 27,
    title: "깃털처럼 가벼운",
    cover: "https://down.mixtape.so/NAS/img/a/7/8/a/a78a7c544415d8d948dd0927a1b25480.jpg",
    year: "2026",
    color: "#10101a",
    desc: "세상의 소음 속 유약한 서로를 꼭 붙잡아 따뜻한 안정감을 주는 위로의 노래.",
    tracks: [
      { n: 1, title: "깃털처럼 가벼운", mood: "사람들의 시선과 불필요한 말들에\n쉽게 흔들리거나 동요하지 말기를" },
    ...
    {
    id: 29,
    title: "이 파도가 멈추지 않았으면 해",
    cover: "https://down.mixtape.so/NAS/img/b/6/a/3/b6a3f13102481133701aa33da2482cd6.jpg",
    year: "2026",
    color: "#10101a",
    desc: "지나온 그리움을 안고 오늘을 다시 살아가는 청춘을 향한 따스한 위로.",
    tracks: [
  {
    n: 1,
    title: "이 파도가 멈추지 않았으면 해",
    mood: "이 파도가 멈추지 않았으면 해\n밀려오고 또 밀려와 줘",
  },
      { n: 2, title: "다정했던 모든 것들에게", mood: "다정했던 모든 것들에게\n나의 마음을 전해" },
      { n: 3, title: "난 무슨 말을 하고 싶었던 걸까", mood: "어쩌면 내가 말하고 싶었던 건 근사한 위로가 아니라\n다듬어지지 않은 단순한 고백 하나였을지도 몰라" },
      { n: 4, title: "애매한 재능", mood: "텅 빈 손을 천천히 쥐었다 펴며\n사라져가는 내 테두리를 봐" },
      { n: 5, title: "터무니없는 일에 내 전부를 걸거야", mood: "내가 선택한 길을 정답으로 만들 거야\n터무니없는 일에 내 전부를 걸거야" },
      { n: 6, title: "내일 날씨는 모두 맑음", mood: "내일 날씨는 모두 맑음이야\n슬픔 하나 없는 마음이야" },
      { n: 7, title: "언젠가 우리는 늙어 젊었던 날들을 그리워하겠지요", mood: "우리는 아름다워서 아팠던게 아니라\n아리도록 불안했기에 그토록 푸르렀던걸까요" }
    ]
  },
    {
    id: 30,
    ...
    desc: "세상의 소음 속 유약한 서로를 꼭 붙잡아 따뜻한 안정감을 주는 위로의 노래.",
    tracks: [
      { n: 1, title: "완전한 무조건적 사랑의 형태", mood: "나를 다 내어주고 텅 비어 버린 날이 오면\n더 나누어 줄 온기가 남지 않았음에 가슴이 아플 것 같아" },
      { n: 2, title: "평안에 젖어 있는 건 아닐까", mood: "될 리 없는 일을 상상하고, 갈 수 없는 곳을 얘기하고\n내 것이 아닌 미래까지 겁도 없이 사랑했었는데" },
      { n: 3, title: "언젠가 그리워질 오늘아", mood: "찬란하지 않아도 좋아, 완벽하지 않아도 괜찮아\n언젠가 그리워질 오늘아, 제발 부디 무탈하기를" }
    ]
  },
      {
    id: 31,
    ...
    tracks: [
      { n: 1, title: "밤을 건너는 아이들아", mood: "저마다의 무게를 견디며 밤을 건너는 아이들아\n참으로 길고 아득한 밤의 외곽을 걸어왔구나" },
      { n: 2, title: "우울아, 너의 다정함에 나는 괴로워", mood: "우울아, 너의 다정함에 나는 괴로워\n날 구원하는 척하며 더 깊은 곳으로 이끌잖아" },
      { n: 3, title: "쓸쓸한 어른이 되어버렸거든요", mood: "혼자 참아내는 것도 제법 잘해요\n외로운 마음을 숨기는 데 익숙한 쓸쓸한 어른이 되어버렸거든요" }
    ]
  }
];

export const ALL_TRACKS = ALBUMS.flatMap(a => a.tracks.map(t => ({...t, album:a.title})));
...
export const NEWS_ITEMS = [
  { date:"26.04.03", title:"'겨울의 대삼각형' 제주도교육청 교육자료 수록" },
  { date:"26.06.11", title:"밤하늘극장 공식 팬페이지 오픈" },
  { date:"26.06.28", title:"오마이걸 효정님의 추천곡으로 '죽어가는 모든 것들을 사랑해야지' 라디오 소개" },
  { date:"26.08.22", title:"유튜브 구독자 2,000명 달성" },
];
