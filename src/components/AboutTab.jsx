  ...
  <main className="subpage">
    <section className="page-shell sub-hero">
      ...
      <div className="hero-copy">
        <p>
          저마다의 삶에는 저마다의 무게가 있습니다. 우리는 꿈과 사랑,
          걱정과 책임을 짊어진 채 정신없는 하루를 살아갑니다.
          그리고 하루의 소음이 모두 멎은 밤, 비로소 자신의 마음과
          지나온 시간을 돌아보게 됩니다. 밤하늘극장은 그때 누구에게나
          펼쳐지는 밤하늘을 하나의 거대한 극장으로 바라보며 시작되었습니다.
        </p>

        <p>
          밤하늘극장의 노래가 누군가의 삶을 대신 살아주거나 모든 아픔을
          해결해줄 수는 없습니다. 다만 가장 외롭고 고요한 밤,
          “당신만 이런 밤을 살아가는 것은 아니다”라는 마음으로
