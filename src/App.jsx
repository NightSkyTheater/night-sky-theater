  ...
  return (
    <div
      style={{
        ...
        // 🌌 밤하늘 배경
        background:
          "radial-gradient(circle at top, #1a1a2e 0%, #0b0b10 60%, #000 100%)",
      }}
    >
      {/* 🌌 타이틀 */}
      <div
      ...
      >
        {entries.map((e, idx) => {
          const rotate = (idx % 5 - 2) * 1.5;
          const pastel = e.color || "#B8FF00";
